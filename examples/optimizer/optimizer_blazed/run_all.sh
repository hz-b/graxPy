...
echo "==> Running 0_fit_blazed_grating.py"
"${PYTHON_BIN}" "${SCRIPT_DIR}/0_fit_blazed_grating.py"
...
echo "==> Running 3_plot_blazed_fit_comparison.py"
"${PYTHON_BIN}" "${SCRIPT_DIR}/3_plot_blazed_fit_comparison.py"
