...
parser = argparse.ArgumentParser(description="Blazed multilayer low-memory sweep")
parser.add_argument(
    "--solver",
...
if __name__ == "__main__":
    ...
    csv_path = output_dir / f"blazed_multilayer_memory_comparison_{args.solver}.csv"
    plot_path = output_dir / f"blazed_multilayer_memory_comparison_{args.solver}.png"
