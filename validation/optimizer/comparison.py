...
plt.plot(df_f3["Energy"], df_f3["alpha4_order1"],
...
plt.title("Comparison (alpha = 4°)", fontsize=FONTSIZE_TITLE, fontweight='bold')
plt.grid()
...
plt.savefig(example_root / "comparison.png", dpi=300, bbox_inches='tight')
plt.close()
