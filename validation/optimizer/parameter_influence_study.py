"""Study the influence of simulation parameters on laminar-grating efficiency.
...
# Enable logging
grax.setup_logging(level="INFO", run_id="laminar_parameter_study")
...
grating = grax.LaminarGrating(**base_grating_params)
