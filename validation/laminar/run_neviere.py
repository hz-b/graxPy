"""Run the laminar 400 l/mm fixed-angle sweep with the Nevière differential method.

Writes ``results/laminar_fixed_angle_all_orders_neviere.csv`` plus a plot against
...
python validation/laminar/run_neviere.py --quick
```
"""
...
parser = argparse.ArgumentParser(description="Laminar 400 l/mm fixed-angle sweep (Nevière)")
...
def main() -> None:
    ...
    axis.set_title("Nevière Differential-Method Simulation vs Experimental Data")
