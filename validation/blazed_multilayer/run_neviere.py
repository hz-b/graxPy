...
Writes ``results/blazed_multilayer_all_orders_neviere.csv`` plus a second-order plot
...
```bash
python validation/blazed_multilayer/run_neviere.py --stride 10
python validation/blazed_multilayer/run_neviere.py --quick
```
"""
...
parser = argparse.ArgumentParser(description="Blazed multilayer energy-angle sweep (Nevière)")
