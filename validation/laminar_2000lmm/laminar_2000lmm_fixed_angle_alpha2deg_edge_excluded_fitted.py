"""Fixed-angle energy sweep for the edge-excluded fitted layered 2000 l/mm laminar grating at alpha = 2 deg."""
...
grax.setup_logging(level="INFO", run_id="laminar_2000lmm_fixed_angle_alpha2deg_edge_excluded_fitted")
...
fitted_parameters_path = (
    example_root
    / "results"
    / "laminar_2000lmm_optimize_top_layers_alpha2deg_edge_excluded"
    / "fitted_parameters.json"
)
results_dir = example_root / "results"
results_dir.mkdir(parents=True, exist_ok=True)

csv_path = results_dir / "laminar_2000lmm_fixed_angle_alpha2deg_edge_excluded_fitted_all_orders.csv"
comparison_plot_path = (
    results_dir / "laminar_2000lmm_fixed_angle_alpha2deg_edge_excluded_fitted_comparison.png"
)
profile_plot_path = results_dir / "laminar_2000lmm_fixed_angle_alpha2deg_edge_excluded_fitted_profile.png"

if not fitted_parameters_path.exists():
    raise FileNotFoundError(
        f"Missing fitted parameters file: {fitted_parameters_path}. "
        "Run laminar_2000lmm_optimize_top_layers_alpha2deg_edge_excluded.py first."
    )
...
batch_result = list(
    runner.run_cases(
        cases,
        metadata={
            "description": "Laminar 2000 l/mm fixed-angle sweep with edge-excluded optimized SiO2/C4O layers",
            ...
            "excluded_energy_windows_ev": [list(window) for window in EDGE_EXCLUDED_ENERGY_WINDOWS_EV],
            "grazing_angle_deg": 2.0,
            "diffraction_order": 1,
...
axis.set_title("Laminar 2000 l/mm Fixed-Angle Sweep at Alpha = 2 deg (Edge-Excluded Fitted Layers)")
