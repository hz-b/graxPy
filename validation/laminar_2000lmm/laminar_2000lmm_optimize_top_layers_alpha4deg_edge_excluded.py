"""Optimize top-layer thicknesses against alpha = 4 deg measurements excluding edge energies."""
...
grax.setup_logging(level="INFO", run_id="laminar_2000lmm_optimize_top_layers_alpha4deg_edge_excluded")

example_root = Path(__file__).resolve().parent
measurement_path = (
    example_root / "simulation" / "lG2000-DLS-B07_ascan-(twt-non)_energy_1order_alpha-4deg.dat"
)
output_dir = example_root / "results" / "laminar_2000lmm_optimize_top_layers_alpha4deg_edge_excluded"
...
spec = {
    ...
    "experiment_name": "laminar_2000lmm_top_layers_alpha4deg_edge_excluded",
