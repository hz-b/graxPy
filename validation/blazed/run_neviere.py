...
Writes ``results/blazed_comparison_monochromator_orders_1_3_neviere.csv`` plus an
...
```bash
python validation/blazed/run_neviere.py
python validation/blazed/run_neviere.py --quick
```
"""
...
parser = argparse.ArgumentParser(description="Blazed 600 l/mm monochromator sweep (Nevière)")
