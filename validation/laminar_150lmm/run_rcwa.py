"""Run the laminar 150 l/mm monochromator sweep with the RCWA solver.

Writes ``results/laminar_150lmm_monochromator_all_orders_rcwa.csv`` plus an
...
```bash
python validation/laminar_150lmm/run_rcwa.py
python validation/laminar_150lmm/run_rcwa.py --quick
```
"""
...
parser = argparse.ArgumentParser(description="Laminar 150 l/mm monochromator sweep (RCWA)")
