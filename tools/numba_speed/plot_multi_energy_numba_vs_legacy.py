...
parser = argparse.ArgumentParser(description="Plot multi-energy numpy vs numba comparison")
parser.add_argument(
    "--csv-path",
    type=Path,
    default=Path(__file__).resolve().parent / "results" / "multi_energy_numba_vs_numpy.csv",
)
parser.add_argument(
    "--output-dir",
    type=Path,
