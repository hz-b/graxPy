"""Compare RCWA baseline vs optional Numba Fourier backend across many energies."""
...
csv_path = output_dir / "multi_energy_numba_vs_legacy.csv"
...
lines = [
    "RCWA Multi-Energy Fourier Backend Comparison (baseline vs numba-optional)",
    "",
    ...
    "",
    "per_energy",
    "energy_ev  baseline_total_s  numba_total_s  baseline_fourier_s  numba_fourier_s  speedup  eff_delta_order_m1",
]
