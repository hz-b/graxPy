...
def create_app(*, data_dir: str | Path | None = None):
    ...
    @app.post("/multilayer/<study_id>/delete")
    def multilayer_delete(study_id: str):
        _study_store().delete_many([study_id])
        return redirect(url_for("multilayer_index"))

    @app.post("/multilayer/<study_id>/stages/<stage>/run")
    ...
    @app.get("/multilayer/<study_id>/stages/<stage>/status")
    ...
    @app.get("/multilayer/<study_id>/stages/<stage>/abort")
    ...
    @app.post("/multilayer/<study_id>/stages/<stage>/abort")
    ...
    @app.post("/multilayer/<study_id>/stages/<stage>/reset")
